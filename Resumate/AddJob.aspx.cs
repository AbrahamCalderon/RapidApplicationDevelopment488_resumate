...
public partial class AddJob : System.Web.UI.Page
{
   protected void Page_Load(object sender, EventArgs e)
   {
      ...
      {
          Response.Redirect("Create.aspx#Work");
      }
   }
   ...
   protected void Add(object sender, EventArgs e)
   {
      ...
      {
         errorLabe.Text = "Enter Company Name";
         company.Focus();
      }
      ...
      else
      {
         ...
         sc.ExcuteAction("INSERT INTO jobs (userID, company, position, description, startDate, endDate, city, state, country)" +
         " VALUES ('" + userID + "', '"
         + company.Text + "', '"
         + position.Text + "', '"
         + description.Text + "', '"
