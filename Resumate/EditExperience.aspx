<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditExperience.aspx.cs" Inherits="EditExperiences" %>
        ...
        <table cellpadding="5" cellspacing="0" border="1" style="width:450px; margin:0px auto;">
            ...
            <tr>
                ...
                <td style="background-color:#dadada">
                    ...
                    <asp:TextBox ID="description" runat="server" Height="20px" Width="269px" 
